...
namespace Watermelon
{
    public class LinkedTileEffect : TileEffect
    {
        ...
        {
            particleHash = ParticlesController.RegisterParticle(pickUpParticle);
        }
        ...
        public override void OnTileSubmitted()
        {
            ...
            {
                if (particleHash != -1)
                    ParticlesController.PlayParticle(particleHash).SetPosition(linkedTile.transform.position);
            ...
            {
                if (particleHash != -1)
                    ParticlesController.PlayParticle(particleHash).SetPosition(secondLinkedTile.transform.position);
            ...
            AudioController.PlaySound(AudioController.AudioClips.rubberSound, volumePercentage: 0.5f);
        }
