...
namespace Watermelon
{
    ...
    public class LevelDatabase : ScriptableObject
    {
        ...
        // Editor stuff
        [SerializeField, LevelEditorSetting] Color selectedColor = new Color(0.204f, 1f, 0f, 1f);
        [SerializeField, LevelEditorSetting] Color unselectedColor = new Color(1f, 1f, 1f, 0f);
        [SerializeField, LevelEditorSetting] Color tintColor = new Color(0f, 0f, 0f, 0.11f);
        [SerializeField, LevelEditorSetting] Color backgroundColor = new Color(0.576f, 0.576f, 0.576f, 0.823f);
        [SerializeField, LevelEditorSetting] Color gridColor = new Color(0, 0, 0, 0.537f);
