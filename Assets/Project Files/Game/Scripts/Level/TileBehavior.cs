...
namespace Watermelon
{
    public class TileBehavior : MonoBehaviour, IClickableObject, ISlotable
    {
        ...
        public virtual void Init(TileData tileData, ElementPosition elementPosition)
        {
        ...
        public virtual void OnObjectClicked()
        {
            ...
            {
                AudioController.PlaySound(AudioController.AudioClips.tileClickBlocked);
        ...
        public void Clear()
        {
            ...
            transform.SetParent(PoolManager.DefaultContainer);
